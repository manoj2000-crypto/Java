...
public class NameUpdateWindow extends JFrame implements ActionListener
{
	Connection con = null;
	...
	public NameUpdateWindow()
	{
		jf = new JFrame("Name Update");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s.equals("UPDATE"))
		{
			try 
			{
				...
				ps = con.prepareStatement("UPDATE student1 SET name=? where rno=?");
