...
package update.phoneNumberUpdate;
...
public class PhnoUpdateWindow extends JFrame implements ActionListener
{
	Connection con = null;
	...
	JButton    jb1;
    	...
    	public PhnoUpdateWindow()
	{
		jf = new JFrame("Phone Number Update");
		...
		jl2 = new JLabel("Enter New Phone Number");
                jl2.setSize(300,40);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s.equals("UPDATE"))
		{
			try 
			{
				...
				ps = con.prepareStatement("UPDATE student1 SET phno=? where rno=?");
                        	ps.setLong(1, Long.parseLong( jtf2.getText() ) );//
